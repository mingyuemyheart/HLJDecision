...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
	...
	protected LinearLayout expand_ll;
	...
	private float mAnimAlphaStart; // start Animation
	...
	private void init(AttributeSet attrs) {
		...
		if (mExpandDrawable == null) {
			mExpandDrawable = getResources().getDrawable(R.drawable.iv_arrow_white_down);
		}
		if (mCollapseDrawable == null) {
			mCollapseDrawable = getResources().getDrawable(R.drawable.iv_arrow_white_top);
		}
	...
	private void findViews() {
		...
		expand_ll = (LinearLayout) findViewById(R.id.expand_ll);
		expand_ll.setOnClickListener(this);
