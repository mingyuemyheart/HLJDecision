...
open class BaseActivity : Activity() {
	...
	private var mDialog: MyDialog2? = null
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		if (intent.hasExtra(CONST.ACTIVITY_NAME) && intent.hasExtra(CONST.COLUMN_ID)) {
	...
	private fun getCheckLocationAuthority() {
		val sp = getSharedPreferences(Manifest.permission.ACCESS_FINE_LOCATION, Context.MODE_PRIVATE)
	...
	protected fun checkLocationAuthority(locationCallback: LocationCallback?) {
		...
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
			if (isCheckLocationAuthority) {
				...
				ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION), AuthorityUtil.AUTHOR_LOCATION)
			}
		} else {
			if (locationCallback != null) {
...
//	--------------------------------------------------------------------
	...
	private fun getCheckStorageAuthority() {
		val sp = getSharedPreferences(Manifest.permission.READ_EXTERNAL_STORAGE, Context.MODE_PRIVATE)
	...
	protected fun checkStorageAuthority(storageCallback: StorageCallback?) {
		...
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
			if (isCheckStorageAuthority) {
				...
				ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE), AuthorityUtil.AUTHOR_STORAGE)
			}
		} else {
			if (storageCallback != null) {
...
//	--------------------------------------------------------------------
	...
	private fun getCheckCameraAuthority() {
		val sp = getSharedPreferences(Manifest.permission.CAMERA, Context.MODE_PRIVATE)
	...
	protected fun checkCameraAuthority(cameraCallback: CameraCallback?) {
		...
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
			if (isCheckCameraAuthority) {
				...
				ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.CAMERA), AuthorityUtil.AUTHOR_CAMERA)
			}
		} else {
			if (cameraCallback != null) {
...
//	--------------------------------------------------------------------
	...
	private fun getCheckPhoneAuthority() {
		val sp = getSharedPreferences(Manifest.permission.READ_PHONE_STATE, Context.MODE_PRIVATE)
	...
	protected fun checkPhoneAuthority(phoneCallback: PhoneCallback?) {
		...
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
			if (isCheckPhoneAuthority) {
				...
				ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.READ_PHONE_STATE), AuthorityUtil.AUTHOR_PHONE)
			}
		} else {
			if (phoneCallback != null) {
...
//	--------------------------------------------------------------------
	...
	private fun getCheckCallAuthority() {
		val sp = getSharedPreferences(Manifest.permission.CALL_PHONE, Context.MODE_PRIVATE)
	...
	protected fun checkCallAuthority(callCallback: CallCallback?) {
		...
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
			if (isCheckCallAuthority) {
				...
				ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.CALL_PHONE), AuthorityUtil.AUTHOR_CALL)
			}
		} else {
			if (callCallback != null) {
