...
public class CONST {
	...
	public static final LatLng guizhouLatLng = new LatLng(centerLat,centerLng);
	public static final double defaultLat = 45.802270;
	public static final double defaultLng = 126.536260;
